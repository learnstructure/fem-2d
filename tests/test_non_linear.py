import pytest
from fem2d import Structure, Node, ElasticMaterial, TrussElementNL, Results


def test_truss_nonlinear():
    ...
    assert abs(disp["uy"][1] - -0.6499578914694384) < 1e-9
    assert abs(el_forces["fx_i"][2] - -1768.7701456115713) < 1e-9
